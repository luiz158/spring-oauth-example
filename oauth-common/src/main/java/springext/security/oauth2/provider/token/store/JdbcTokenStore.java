package springext.security.oauth2.provider.token.store;
...
public class JdbcTokenStore implements TokenStore {
    ...
    public OAuth2AccessToken getAccessToken(OAuth2Authentication authentication) {
        ...
        LOG.warn("Key extracted: " + key);
        try {

            LOG.warn("RUN QUERY:\n" + selectAccessTokenFromAuthenticationSql);
    ...
    public void storeAccessToken(OAuth2AccessToken token, OAuth2Authentication authentication) {
        ...
        LOG.warn("storeAccessToken refreshToken=" + refreshToken);
        LOG.warn("storeAccessToken token=" + token.getValue());
    ...
    public OAuth2AccessToken readAccessToken(String tokenValue) {
        LOG.warn("readAccessToken Token=" + tokenValue);
        OAuth2AccessToken accessToken = null;
    ...
    public void removeAccessToken(String tokenValue) {
        LOG.warn("removeAccessToken RUN QUERY:\n" + deleteAccessTokenSql);
    ...
    public OAuth2Authentication readAuthentication(String token) {
        LOG.warn("readAuthentication Token=" + token);
        OAuth2Authentication authentication = null;

        try {
            LOG.warn("readAuthentication RUN QUERY:\n" + selectAccessTokenAuthenticationSql);
    ...
    public void storeRefreshToken(OAuth2RefreshToken refreshToken, OAuth2Authentication authentication) {
        LOG.warn("storeRefreshToken RUN QUERY:\n" + insertRefreshTokenSql);
    ...
    public OAuth2RefreshToken readRefreshToken(String token) {
        ...
        try {
            LOG.warn("readRefreshToken RUN QUERY:\n" + selectRefreshTokenSql);
    ...
    public OAuth2Authentication readAuthenticationForRefreshToken(String value) {
        LOG.warn("readAuthenticationForRefreshToken value=" + value);
        OAuth2Authentication authentication = null;

        try {
            LOG.warn("RUN QUERY:\n" + selectRefreshTokenAuthenticationSql);
    ...
    public Collection<OAuth2AccessToken> findTokensByUserName(String userName) {
        LOG.warn("findTokensByUserName userName=" + userName);
        List<OAuth2AccessToken> accessTokens = new ArrayList<OAuth2AccessToken>();
    ...
    public Collection<OAuth2AccessToken> findTokensByClientIdAndUserName(String clientId, String userName) {
        LOG.warn("findTokensByClientIdAndUserName clientId=" + clientId);
        LOG.warn("findTokensByClientIdAndUserName userName=" + userName);
        List<OAuth2AccessToken> accessTokens = new ArrayList<OAuth2AccessToken>();
